...
<Project Type="Project" LVVersion="16008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="SubVI" Type="Folder">
			<Item Name="Bias_adjustment.vi" Type="VI" URL="../SubVI/Bias_adjustment.vi"/>
			<Item Name="Generate sorted scan parameters.vi" Type="VI" URL="../SubVI/Generate sorted scan parameters.vi"/>
			<Item Name="GV.vi" Type="VI" URL="../SubVI/GV.vi"/>
			<Item Name="ITX_Global.vi" Type="VI" URL="../SubVI/ITX_Global.vi"/>
			<Item Name="Post action control.vi" Type="VI" URL="../SubVI/Post action control.vi"/>
			<Item Name="PPMS Dashboard.glb.vi" Type="VI" URL="../SubVI/PPMS Dashboard.glb.vi"/>
			<Item Name="Scale Voltage.vi" Type="VI" URL="../SubVI/Scale Voltage.vi"/>
			<Item Name="Scan action control.vi" Type="VI" URL="../SubVI/Scan action control.vi"/>
			<Item Name="Voltage Update.vi" Type="VI" URL="../SubVI/Voltage Update.vi"/>
		</Item>
		<Item Name="B_sweep_3ch_DR_v2.1.vi" Type="VI" URL="../B_sweep_3ch_DR_v2.1.vi"/>
		<Item Name="B_sweep_versus time_3ch_DR_v2.1.vi" Type="VI" URL="../B_sweep_versus time_3ch_DR_v2.1.vi"/>
		<Item Name="Four_terminal_IV_3VoltageAmp_3.1.vi" Type="VI" URL="../Four_terminal_IV_3VoltageAmp_3.1.vi"/>
		<Item Name="Lockin-4461_3.0.vi" Type="VI" URL="../Lockin-4461_3.0.vi"/>
		<Item Name="Read current vs temperature_3ch_2.1.vi" Type="VI" URL="../Read current vs temperature_3ch_2.1.vi"/>
		<Item Name="refresh Vbg.vi" Type="VI" URL="../refresh Vbg.vi"/>
		<Item Name="Sweep control - Copy.vi" Type="VI" URL="../Sweep control - Copy.vi"/>
		<Item Name="Sweep control.vi" Type="VI" URL="../Sweep control.vi"/>
		<Item Name="Vbg_sweep_for_different_configs.vi" Type="VI" URL="../Vbg_sweep_for_different_configs.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="user.lib" Type="Folder">
				...
				<Item Name="Switch status IO - Human Readable.vi" Type="VI" URL="/&lt;userlib&gt;/LevyLab/Pickering/subVI/Switch status IO - Human Readable.vi"/>
				<Item Name="Switch status IO - Human Readable_3voltageamp.vi" Type="VI" URL="/&lt;userlib&gt;/LevyLab/Pickering/subVI/Switch status IO - Human Readable_3voltageamp.vi"/>
			</Item>
